...
/*
Q.1. A bracket is considered to be any one of the following characters:
(, ), {, }, [, or ].
...
is also a matched pair of brackets. Given  strings of brackets, determine whether 
each sequence of brackets is balanced. If a string is balanced, return YES. Otherwise, return NO.
